...
def apply_membership_discount(grand_total, is_member):
    ...
    """
    if is_member and grand_total > 0:
...
if __name__ == "__main__":
    ...
    final_total, membership_discount, membership_exp = apply_membership_discount(discounted_total, is_member)
    if membership_discount > 0:
        print(f"- {membership_exp}")
    
    print(f"Final Grand Total: ₹{final_total:.2f}")
